...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Messagerie instantanée Bluetooth");
        initView();
    }
        ...
        XPermissionUtil.requestPermissions(this, 1,
                ...
                new XPermissionUtil.OnPermissionListener() {
                    ...
                    public void onPermissionDenied() {
                        ...
                        Snackbar.make(bottomNavigationView, "Veuillez accéder manuellement à l'écran des paramètres pour accorder les autorisations nécessaires.", Snackbar.LENGTH_LONG).show();
                    }
                });
    }
