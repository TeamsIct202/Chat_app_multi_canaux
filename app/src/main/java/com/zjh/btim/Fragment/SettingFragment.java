...
public class SettingFragment extends Fragment implements View.OnClickListener {
    ...
    private static final String VALUE_OPEN = "Bluetooth est activé\nCliquez pour fermer";
    private static final String VALUE_CLOSE = "Bluetooth n'est pas activé\nCliquer pour ouvrir";
    ...
    public void onDestroy() {
        Log.i("zjh-onDestroy", "SettingFermer");
        super.onDestroy();
